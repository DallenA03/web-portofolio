  ...
  <footer id="kontak" className="bg-black text-white py-20 px-4">
    <div className="max-w-6xl mx-auto text-center">
      ...
      <p className="text-lg sm:text-xl mb-12 opacity-80 max-w-2xl mx-auto">
        Interested in collaborating or want to know more about my work? Let's create something amazing together.
      </p>
      <div className="flex flex-col md:flex-row justify-center gap-6 mb-20">
        ...
        <div className="flex justify-center gap-4">
          <a href="https://github.com/DallenA03" className="p-4 border-4 border-white hover:bg-gray-700 transition-colors"><FaGithub size={26} /></a>
          <a href="https://www.linkedin.com/in/francesco-dallen/" className="p-4 border-4 border-white hover:bg-blue-600 transition-colors"><FaLinkedin size={26} /></a>
        </div>
      </div>
      <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm opacity-50">
        <p>© 2026 FRANCESCO DALLEN. ALL RIGHTS RESERVED.</p>
      </div>
    </div>
  </footer>
);
